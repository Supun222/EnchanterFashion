...
namespace Enchanter_Fashion
{
    public partial class displaypanel : Form
    {
        ...
        string filedirectory = @"D:\UOK MIT\2nd year Fisrt Sem\INTE 21223 - Interactive Application Development\project\Enchanter Fashion\Display Board\Images\";
        ...
        {        
            ...
            Console.WriteLine(getvalue.backfilename);
            background1.Image = Image.FromFile(filedirectory + getvalue.backfilename);
